...
import 'package:b21pdf/features/viewers/excel/presentation/excel_viewer_controller.dart';
...
class ExcelViewerScreen extends BaseScreen<ExcelViewerController> {
  const ExcelViewerScreen({super.key});
  @override
  ExcelViewerController createController() => ExcelViewerController();
  @override
  Color get navigationBarColor => Colors.white;

  @override
  Future<bool> canPopRoute(ExcelViewerController controller) async {
    controller.onBackPressed();
    return false;
  }

  @override
  Widget buildContent(BuildContext context, ExcelViewerController controller) =>
      GetBuilder<ExcelViewerController>(
        init: controller,
        global: false,
  ...
  Widget _buildMainContent(ExcelViewerController controller) => Expanded(
    child: Container(
  ...
  Widget _buildBottomBar(ExcelViewerController controller) => Padding(
  ...
  Widget _buildTitleBar(ExcelViewerController controller) => Container(
    width: double.infinity,
    color: Colors.white,
    child: SafeArea(
      top: true,
